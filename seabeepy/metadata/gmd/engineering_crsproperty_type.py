...
from seabeepy.metadata.gmd.abstract_crstype import EngineeringCrs
...
class EngineeringCrspropertyType:
    """
    gml:EngineeringCRSPropertyType is a property type for association roles to
    an engineering coordinate reference system, either referencing or
