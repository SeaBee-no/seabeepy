...
from seabeepy.metadata.gmd.abstract_crstype import ImageCrs
...
class ImageCrspropertyType:
    """
    gml:ImageCRSPropertyType is a property type for association roles to an
    image coordinate reference system, either referencing or containing the
